...
;; public interfaces
(defn create-xml-ontology [file-loc]
  "Return the XML representation of the ontology for access using all of the find-* functions"
  (->> file-loc java.io.File. xml/parse zip/xml-zip))
...
;; primary method to interact with.
